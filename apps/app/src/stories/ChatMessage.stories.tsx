...
export const GroupedMessages: Story = {
    render: () => (
        <div style={{ maxWidth: 600 }}>
            <ChatMessage message={agentMsg} agentName="Milady" />
            <ChatMessage
                message={{ ...agentMsg, id: "msg-2b", text: "Would you like more details?" }}
                agentName="Milady"
                isGrouped
            />
        </div>
...
export const Interrupted: Story = {
    render: () => (
        <div style={{ maxWidth: 600 }}>
            <ChatMessage message={interruptedMsg} agentName="Milady" onRetry={() => alert("retry")} />
        </div>
    ),
};
...
export const Conversation: Story = {
    ...
    render: () => (
        <div style={{ maxWidth: 600 }}>
            ...
            <ChatMessage message={agentMsg} agentName="Milady" />
            <ChatMessage
                message={{ ...userMsg, id: "msg-5", text: "Thanks! Any rain expected?" }}
                agentName="Milady"
            />
            <ChatMessage
                message={{ ...agentMsg, id: "msg-6", text: "Only a 20% chance on Sunday afternoon. You should be fine!" }}
                agentName="Milady"
            />
        </div>
    ),
