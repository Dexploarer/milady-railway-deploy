...
const baseProps = {
    conv: { id: "conv-1", title: "Hello World", updatedAt: new Date().toISOString() },
    isActive: false,
    isEditing: false,
    isUnread: false,
    isGameModal: false,
...
export const Default: Story = {
    render: () => (
        <div style={{ width: 260, border: "1px solid var(--border)", background: "var(--bg)" }}>
...
export const ConfirmDelete: Story = {
    render: () => (
        <div style={{ width: 320, border: "1px solid var(--border)", background: "var(--bg)" }}>
