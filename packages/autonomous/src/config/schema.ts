...
const FIELD_LABELS: Record<string, string> = {
  ...
  "database.pgliteHttp.url": "PGlite HTTP Server URL",
  "database.pgliteHttp.authToken": "PGlite HTTP Auth Token",
  "database.pgliteHttp.timeoutMs": "PGlite HTTP Timeout (ms)",
  ...
  "database.postgres.database": "PostgreSQL Database",
  "database.postgres.user": "PostgreSQL User",
  "database.postgres.password": "PostgreSQL Password",
  "database.postgres.ssl": "PostgreSQL SSL",
